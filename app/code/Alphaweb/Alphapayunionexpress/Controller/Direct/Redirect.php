...
{
    /**
     * @var \Alphaweb\Alphapayunionexpress\Model\Api\RedirectApi
     */
   // protected $_api;
    ...
    public function execute()
    {
        try {
            ...
            if ($this->_quote->getId()) {
                ...
                if (!$this->_quote->getGrandTotal()) {
                    throw new \Magento\Framework\Exception\LocalizedException(
                        __(
                            'Alphapayunionexpress can\'t process orders with a zero balance due. '
            ...
            if($this->is_app_client()){
                ...
                $api_uri ="$base_url/api/v1.0/gateway/partners/%s/pre_card_orders/%s";
            }
